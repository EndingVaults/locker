...
task.spawn(function()
    ...
    watermark:Update { "EzCrack.lua", ScriptProperties.UserPanel.Status, frames .. " FPS", string.format("%s:%s %s", tonumber(os.date("%I")), os.date("%M"), os.date("%p")) }
...
Discord = {
    ...
    DiscordCopyInv = Sections.Configuations.Discord:Button { Name = "Copy Invite", Callback = function()
        setclipboard("https://discord.gg/lockers")
    end }
...
Library:ChangeAccent(Color3.fromRGB(184, 7, 7))
Library:ChangeOutline { Color3.fromRGB(255, 5, 5), Color3.fromRGB(171, 5, 85) }
