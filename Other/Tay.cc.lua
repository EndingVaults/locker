...
LeftGroupBox:AddToggle('Showdot', {
    ...
    Tooltip = 'Set', -- Information shown when you hover over the toggle
});
...
--[[
local RightGroupBox = Tabs.Main:AddRightGroupbox('yea')
]]
--[[
